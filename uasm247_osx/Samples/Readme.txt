 ...
 -------------------------------------------------------------------
  ...
  osx1.asm              macho64 console Simple Hello world, raw
  osx2.asm              macho64 console Simple Hello world, using invoke/proc/hll

  hello.asm             win64/elf64/macho64 console Fully cross platform Hello World.

  flat.asm              bin     -        Demonstrates UASM flat mode, ideal for bootloaders and pre-kernel os coding.
